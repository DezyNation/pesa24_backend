...
Route::middleware(['auth:api', 'profile', 'minimum_balance'])->group(function () {
    /*------------------------EKO AEPS------------------------*/
    ...
    Route::post('paysprint/aeps/transaction-status/{service_id}', [AepsApiController::class, 'transactionStatus']);
    /*-----------------------Pysprint AePS-----------------------*/
