...
Route::middleware(['auth:api', 'active'])->group(function () {
    ...
    Route::post('money-transfer', [PaysprintPayout::class, 'moneyTransfer'])->middleware(['mpin', 'minimum_balance', 'concurrency', 'throttle:1,0.08']);
...
Route::post('razorpay/payment-status', [PayoutController::class, 'payoutCall'])->middleware(['auth:api', 'active', 'throttle:1,0.167', 'idempotency']);
