...
Route::middleware(['auth:api', 'minimum_balance', 'active'])->group(function () {
    ...
    Route::post('paysprint/aeps/twofactor-register/{service_id}', [AepsApiController::class, 'twoFactorReg']);
    Route::post('paysprint/aeps/twofactor-authenticate/{service_id}', [AepsApiController::class, 'twoFactorAuth'])->middleware('paysprint_merchant');
    /*-----------------------Pysprint AePS-----------------------*/
