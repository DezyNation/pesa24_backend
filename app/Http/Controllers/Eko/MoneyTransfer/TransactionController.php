...
class TransactionController extends Controller
{
    ...
    public function transactionInquiry()
    {
        ...
        $response = Http::asForm()->withHeaders([
            ...
            'secret-key-timestamp'=> $secret_key_timestamp,
            'secret-key'=> $secret_key,
        ])->get('https://staging.eko.in:25004/ekoapi/v2/transactions/2157011338?initiator_id=9962981729&user_code=20810200');
    ...
    public function refundOtp()
    {
        ...
        $response = Http::asForm()->withHeaders([
            ...
            'secret-key-timestamp'=> $secret_key_timestamp,
            'secret-key'=> $secret_key,
        ])->post('https://staging.eko.in:25004/ekoapi/v2/transactions/2157011338/refund/otp');
