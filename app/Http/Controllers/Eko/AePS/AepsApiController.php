...
class AepsApiController extends CommissionController
{
    ...
    public function moneyTransfer(Request $request)
    {
        ...
        DB::insert(
            ...
            [
                auth()->user()->id, $response->json($key = 'data')['shop'], $response->json($key = 'data')['service_tax'], $response->json($key = 'data')['total_fee'],
    ...
    public function test(int $user_id, int $transaction_id, int $service_id, int $amount)
    {
