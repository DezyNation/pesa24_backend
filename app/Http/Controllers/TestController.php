...
class TestController extends Controller
{
    public function test(Request $request)
    {
        $data = DB::table('transactions')
            ...
            ->select('users.name as trigered_by_name', 'users.phone_number as trigered_by_phone', 'users.organization_id', 'beneficiaries.name', 'beneficiaries.phone_number', 'users.wallet as wallet_amount', 'transactions.user_id', 'transactions.trigered_by', 'transactions.credit_amount', 'transactions.debit_amount')
